...
Olá! Eu sou Washington Luís,atualmente curso Software Engineer e tenho como pretenção trabalhar na área, atuando com DevOps e SEC, hoje eu irei te guiar nesse projeto de DevOps. Sei que conceitos como containerização, IaC e CI/CD podem parecer intimidadores no início. Por isso, adotaremos uma didática simples e prática onde iremos construir o conhecimento **de trás pra frente**. Isso significa começar pelo problema real – algo que você pode vivenciar e sentir a dor – e só depois buscar a solução, experimentando ferramentas como Docker, Terraform e GitHub Actions. No final, conectamos à teoria para solidificar o aprendizado.
